...
class Accessories extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('acc_name, acc_desc, acc_price, acc_date_create, acc_date_update, acc_status, type_id, mem_id', 'required'),
    ...
    public function relations() {
        ...
        return array(
            'accessoriesType' => array(self::BELONGS_TO, 'AccessoriesType', 'type_id'),
        );
    }
